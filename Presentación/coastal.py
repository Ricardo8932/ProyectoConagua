...
<h2>Ejemplo de clasificación de pizzas para entender estos conceptos:</h2>
...
La matriz de confusión para este ejemplo se vería así:

               | Predicción Enfermo | Predicción Sano |
-------------------------------------------------------
Enfermo        |   True Positive (TP) | False Negative (FN) |
-------------------------------------------------------
Sano           |  False Positive (FP) | True Negative (TN)  |
-------------------------------------------------------
